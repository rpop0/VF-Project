...
docker build --build-arg CATEGORIES="vnncomp2022_container" . -t vnncomp2022_image

docker run -d --privileged --name vnncomp2022_container vnncomp2022_image tail -f 
#/dev/null
...
docker cp vnncomp2022_container:/out.csv out.csv
